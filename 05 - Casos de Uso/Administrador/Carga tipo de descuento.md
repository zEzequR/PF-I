...
**Camino alternativo:** 4.a) Los campos obligatorios no están completos o el porcentaje no es válido (ej: mayor a 100). 5.a) Si hay un error de conexión con la base de datos, el sistema muestra el mensaje: “Error al guardar. Intente nuevamente más tarde”. 5.b) El sistema detecta que ya existe un descuento con el mismo motivo y muestra error.

**Escenario de éxito:** El tipo de descuento queda registrado correctamente en la base de datos y queda disponible para su aplicación en ventas.

**Escenario de fracaso:** El sistema no guarda el descuento por datos inválidos, duplicados o por fallo en la conexión con la base de datos.
