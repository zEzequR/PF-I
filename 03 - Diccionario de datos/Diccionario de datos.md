...
| cantidad | cantidad de unidades (venta/pedido) | int | 5 | 0-9 |
...
| email | email de contacto (cliente/prov/emp) | str | 40 | continuo |
...
| descuento | valor del descuento específico | float | 5 | 0-9 |
...
| cuit | clave única de id. tributaria (droguería) | str | 13 | 0-9 |
